...
export class AppPreBootstrap {
    ...
    private static getApplicationConfig(appRootUrl: string, callback: () => void) {
        ...
        XmlHttpRequestHelper.ajax(type, url, customHeaders, null, (result) => {
            ...
            AppConsts.DefaultTID = result.defaultTID;
            ...
            AppConsts.DesFileUpload = result.desFileUpload;
            AppConsts.svcAppBaseUrl = result.svcAppBaseUrl;
            AppConsts.qrVCardLink = result.qrVCardLink;
            AppConsts.deepAppLink = result.deepAppLink;
            AppConsts.gaTrackingCode = result.gaTrackingCode;
