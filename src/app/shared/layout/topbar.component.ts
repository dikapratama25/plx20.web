...
export class TopBarComponent extends ThemesLayoutBaseComponent implements OnInit {
    ...
    allowDownloadCollectedData = false;
    allowVisualSettings = false;
    allowManageLinkedAccounts = false;
    allowManageUserDelegations = false;
    allowSwitchLanguage = false;
    ...
    async setCurrentLoginInformations(): Promise<void> {
        ...
        this.isCompanyNameDisplayed = this.setting.getBoolean('App.Settings.Panel.DisplayCompanyName');
        this.allowDownloadCollectedData = this.setting.getBoolean('App.Settings.Panel.AllowDownloadCollectedData');
        this.allowVisualSettings = this.setting.getBoolean('App.Settings.Panel.AllowVisualSettings');
        this.allowManageLinkedAccounts = this.setting.getBoolean('"App.Settings.Panel.AllowManageLinkedAccounts');
        this.allowManageUserDelegations = this.setting.getBoolean('App.Settings.Panel.AllowManageUserDelegations');
        this.allowSwitchLanguage = this.setting.getBoolean('App.Settings.Panel.AllowSwitchLanguage');
    }
