...
export class CreateOrEditSectionModalComponent extends AppComponentBase {
  ...
  save(): void {
    let url = ProxyURL.CreateUpdateDefaultDTL;
    let data: any[] = [];
    this.inputHelper.BizRegID = this.appStorage.bizRegID;
    this.inputHelper.BizLocID = this.appStorage.bizLocID;
