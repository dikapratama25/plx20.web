...
@Component({
    templateUrl: './theme13-theme-ui-settings.component.html',
    animations: [appModuleAnimation()],
    selector: 'theme13-theme-ui-settings'
})
export class Theme13ThemeUiSettingsComponent extends AppComponentBase {
