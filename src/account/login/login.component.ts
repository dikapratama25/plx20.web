...
export class LoginComponent extends AppComponentBase implements OnInit {
    ...
    get isVendorSelfRegistrationAllowed(): boolean {
        if (!this._sessionService.tenantId) {
            return false;
        }

        return this.setting.getBoolean('App.Entity.VendorManagement.AllowVendorSelfRegistration');
    }

    get isPublic(): boolean {
        return this.appSession.tenant == null || this.appSession.tenant.id === 1;
    }
